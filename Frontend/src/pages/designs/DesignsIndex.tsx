...
const VARIANTS = [
  {
    to: "a",
    name: "סטודיו",
    tag: "חדש · עריכתי · צילומי",
    desc: "צילומי סטילס חמים על נייר שנהב, וידאו עדין ב-hero, חיפוש בתוך ה-hero, ובונה ערכות פתיחה שמכניס ערכה שלמה לעגלה בלחיצה.",
    accent: "#c8401c",
  },
  {
    to: "b",
    name: "פיגמנט",
    tag: "חדש · צבעוני · אינטראקטיבי",
    desc: "hero שמציירים עליו עם העכבר, הצבע שבוחרים צובע את כל העמוד, קנייה לפי גוון על כל שפופרות הצבע, ומד משלוח חינם חי מהעגלה.",
    accent: "#ff5a36",
  },
  {
    to: "d",
  ...
  },
  {
    ...
    name: "מוזיאון",
    tag: "תערוכה · מאופק",
    desc: "החנות כתערוכה: אולמות ממוספרים, מוצרי מבצע כיצירות ממוסגרות על קיר, וקטגוריות בחורי-הצצה גיאומטריים.",
    accent: "#3f5a36",
  },
  {
    to: "j",
    name: "מגזין",
    tag: "דפוס · קולאז'",
    desc: "דף הבית כשער מגזין: פולארוידים מוטים עם נייר-דבק, מדבקת מחיר אדומה, וקטגוריות כתוכן עניינים.",
    accent: "#c4552e",
  },
];
